...
const ViewDetails = () => {
  ...
  const shareViaEmail = (order) => {
    ...
    const body = `  ${imageUrl} Hi, I found this amazing product: ${order.dishes}. It costs Rs ${order.price}. Check it out at ${window.location.href}`;
  ...
  const shareViaWhatsApp = (order) => {
    ...
    const message = `Check out this product: ${order.dishes}. It costs Rs ${order.price}. \n${imageUrl} \nCheck it out at ${productUrl}.`;
            ...
            <Col md={6} className="d-flex align-items-center justify-content-center">
              {item && (
                <div>
                  ...
                  <h2 style={{color:'orange'}}><b>{item.dishes}</b></h2>
